...
export class ParseError {
    ...
    constructor(reason: string, isSyntaxError: boolean, scanner: ScannerLike) {
        this.reason = reason;
...
export class Parser {
     ...
     */
    parse(scanner: ScannerLike): ParseResult {
