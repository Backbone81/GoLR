...
public sealed class Parser
{
    ...
    private ITokenSource _scanner = null!;
    ...
    private StepOutcome Step(out ParseError? error)
    {
        ...
        switch (action & ActionKindMask)
        {
            ...
            case ActionKindError:
                error = new ParseError($"unexpected token {terminal.ToDisplayString()}", ErrorKind.Syntax, _scanner);
                return StepOutcome.Failed;
            default:
                error = new ParseError($"unexpected action {action} in state {state}", ErrorKind.Internal, _scanner);
                return StepOutcome.Failed;
        }
    }
