...
/// </summary>
public readonly struct ParseSymbol
{
    ...
    public override string ToString() =>
        TryGetNonterminal(out Nonterminal nonterminal)
            ? $"nonterminal {nonterminal.ToDisplayString()}"
            : $"terminal {((Token)(_value & SymbolMask)).ToDisplayString()}";
}
...
public sealed class Parser
{
    ...
    private void Reduce(int productionIdx)
    {
        ...
        // takes nothing and leaves an empty array.
        ParseNode[] children = new ParseNode[popCount];
