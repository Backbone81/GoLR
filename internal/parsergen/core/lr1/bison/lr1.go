...
func GrammarToParser(augmentedGrammar frontend.Grammar) (backend.Parser, error) {
	...
	builder := NewLR1(augmentedGrammar)
...
func NewLR1(augmentedGrammar frontend.Grammar) *LR1 {
	return &LR1{
...
func (i *LR1) BuildParser() (parser backend.Parser, err error) { //nolint:nonamedreturns // Required for defer
	bisonGrammarFile, err := os.CreateTemp("", "golr-lr1-*.y")
	if err != nil {
	...
	bisonXmlFile, err := os.CreateTemp("", "golr-lr1-*.xml")
	if err != nil {
		return backend.Parser{}, err
	}
	defer func() {
	...
	if err := bisonutils.BuildLR1(bisonGrammarFile.Name(), bisonXmlFile.Name()); err != nil {
		return backend.Parser{}, err
	}
...
func (i *LR1) buildNonterminalList(report bisonutils.BisonXMLReport, parser *backend.Parser) {
...
func (i *LR1) buildProductionList(report bisonutils.BisonXMLReport, parser *backend.Parser) {
...
func (i *LR1) buildStateList(report bisonutils.BisonXMLReport, parser *backend.Parser) error {
